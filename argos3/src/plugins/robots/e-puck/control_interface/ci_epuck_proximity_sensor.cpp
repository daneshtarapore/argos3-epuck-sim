...
namespace argos 
{
      ...
      m_tReadings_Noiseless(8)
   {
      /* for(size_t i = 0; i < 8; ++i)
      {
       ...
       m_tReadings_Noiseless[0].Angle = CRadians::PI / 10.5884f;
       m_tReadings_Noiseless[1].Angle = CRadians::PI / 3.5999f;
       m_tReadings_Noiseless[2].Angle = CRadians::PI_OVER_TWO;
       m_tReadings_Noiseless[3].Angle = CRadians::PI / 1.2f;
       m_tReadings_Noiseless[4].Angle = CRadians::PI / 0.8571f;
       m_tReadings_Noiseless[5].Angle = CRadians::PI / 0.6667f;
       m_tReadings_Noiseless[6].Angle = CRadians::PI / 0.5806f;
       m_tReadings_Noiseless[7].Angle = CRadians::PI / 0.5247f;
